...
class FlightsInput(BaseModel):
    ...
    outbound_date: Optional[str] = Field(
        description="Parameter defines the outbound date. The format is YYYY-MM-DD. e.g. 2025-09-14"
    )
    return_date: Optional[str] = Field(
        description="Parameter defines the return date. The format is YYYY-MM-DD. e.g. 2025-09-28"
    )
