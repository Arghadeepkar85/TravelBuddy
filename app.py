...
def render_ui():
    st.markdown(
        """
        <style>
        /* Center container fully */
        .center-container {
            display: flex;
            flex-direction: column;
            align-items: center;
            max-width: 700px; /* keeps things from stretching */
            margin: auto;
        }
        ...
        /* Hide the default label of text area */
        label[data-testid="stTextAreaLabel"] > div {
    ...
    st.markdown(
        '<div class="main-title">✈️ TravelBuddy : AI Travel Agent 🏨🗺️</div>',
        unsafe_allow_html=True,
    )
    st.markdown(
    ...
    user_input = st.text_area(
        ...
        height=200,
        key="query",
        placeholder="Sample Query: I want to travel to Tokyo from Madrid from 1-7 of October. Find me flights and 4 star hotels...",
    )

    st.sidebar.image("images/travelbuddy.png", caption="TravelBuddy : AI Travel Agent")
